...
#ifndef __EROBOT_BODY_CORE_KINECT_H__
#define __EROBOT_BODY_CORE_KINECT_H__
...
namespace reactive {
	namespace erobot {
		namespace core {
			class EBodyCoreKinect : public EBodyCore {
...
#endif /* __EROBOT_BODY_CORE_KINECT_H__ */
